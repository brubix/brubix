...
@Configuration
@EnableSwagger2
public class ReferenceDataApiSwaggerConfiguration {

    @Autowired
    private TypeResolver typeResolver;

    private static final String appName = "b-Rubix Reference Data Service";
    ...
    public Docket docket() {
        return getDocket("reference-service-management", PathSelectors.regex("/manage.*"),
    ...
    private ApiInfo apiInfo() {
        return info(String.format("%s Endpoints", appName),
                "This page facilitates the user to try out the b-Rubix Reference Data Service endpoints.");
    }

package com.brubix.reference.controller;
...
@Slf4j
public class ReferenceDataRestControllerAdvice extends ResponseEntityExceptionHandler {

    private MessageSource messageSource;

    @Autowired
    public ReferenceDataRestControllerAdvice(MessageSource messageSource) {

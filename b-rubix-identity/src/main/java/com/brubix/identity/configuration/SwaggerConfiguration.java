...
public class SwaggerConfiguration {
    ...
    private static final String appName = "b-Rubix Identity";
    ...
    public Docket docket() {
        return getDocket("b-Rubix-identity-management", PathSelectors.regex("/manage.*"),
    ...
    private Predicate<String> applicationPaths() {
        Predicate<String> userPath = PathSelectors.regex("/users.*");
        return Predicates.or(userPath);
    }

    private ApiInfo apiInfo() {
        return info(String.format("%s Endpoints", appName),
                "This page facilitates the user to try out the b-Rubix Identity endpoints.");
    }

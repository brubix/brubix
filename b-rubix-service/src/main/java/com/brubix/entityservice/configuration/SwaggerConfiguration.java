...
public class SwaggerConfiguration {
    ...
    private static final String appName = "Brubix Entity Service";
    ...
    public Docket customerOrderApis() {
        return getDocket("entity-service", customerOrderPaths(), RequestHandlerSelectors.any(), apiInfo(),
                new Tag(appName, String.format("REST Endpoints for %s", "Brubix Entity Service")));
    }


    @Bean
    public Docket docket() {
        return getDocket("entity-service-management", PathSelectors.regex("/manage.*"), RequestHandlerSelectors.any(),
    ...
    private Predicate<String> customerOrderPaths() {
        return Predicates.or(PathSelectors.regex("/entity.*"));
    }
